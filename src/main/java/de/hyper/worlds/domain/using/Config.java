...
public class Config extends ConfigBase {
    ...
    public Config() {
        ...
        register("history-use", true, "Define if the history of worlds is enabled (increases storage).");
        register("history-idle-time", 259200000, "Define the time a history record will be stored and deleted after it (given in milliseconds).");
        save();
    }
}